...
updated: 2026-03-26T22:22:15.000Z
tags:
...
1. 生成了新的站点地图文件`atom.xml`和`baidusitemap.xml`，并在Google Search Console中提交了这两个文件。这两个文件也包含了站点的URL信息，Google Search Console能够成功抓取它们，从而间接解决了无法抓取`sitemap.xml`的问题。
